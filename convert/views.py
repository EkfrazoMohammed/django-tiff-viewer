...
def proxy_image(request):
    """
    Fetch and return an image from a dynamically provided URL.
    Example: http://localhost:8000/proxy-image/?url=https://example.com/image.png
    """
    image_url = request.GET.get("url")  # Get URL from query params
    print("hello")
    if not image_url:
